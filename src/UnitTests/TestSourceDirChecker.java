...
//
//    @Test
//    public void testReadDataCountAmountOfItems() throws Exception {
...
//    }
//    @Test
//    public void  testReadDataAndFlush() throws Exception {
//        SourceDirChecker srcDirChecker = new SourceDirChecker(srcPathToFile);
//        srcDirChecker.trackTheFileDirectory();
//        Set<String> listOfFiles = srcDirChecker.getFilesToBeRead();
//        Thread.sleep(1L * 1000L);
...
//
//    @Test
//    public void  testReadDataAndFlushAndReadLater() throws Exception {
//        SourceDirChecker srcDirChecker = new SourceDirChecker(srcPathToFile);
//        srcDirChecker.trackTheFileDirectory();
//        Set<String> listOfFiles = srcDirChecker.getFilesToBeRead();
//        Thread.sleep(1L * 1000L);
...
//    }
//    @Test
//    public void  testReadDataAndFlushAndModify() throws Exception {
//        SourceDirChecker srcDirChecker = new SourceDirChecker(srcPathToFile);
//        srcDirChecker.trackTheFileDirectory();
//        Set<String> listOfFiles = srcDirChecker.getFilesToBeRead();
//        Thread.sleep(1L * 1000L);
